...
<html>
	...
	<div class="container-fluid">
		...
		<div class="main">
			...
			<!-- search form -->
			<div class="search_form_in_page-container hidden-sm hidden-md hidden-lg hidden-xl">
				<form class="search_form" method="GET" action="search.html">
					<input type="text" placeholder="Search" id="search_input" name="search">
					<button type="reset" class="icon-close"></button>
					<button type="submit"><span class="icon icon-magnifier"></span></button>
				...
				<div class="search">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="results hidden-xs">
								<h6>Results for <span>speaker freakers</span></h6>
							</div>
					...
					<div class="row">
						<div class="col-md-4 pull-right">
							...
							<!-- Title -->
							<div class="title">
								<h1><span class="cutWord line-right">Here you go</span></h1>
							</div>
	...
	<div class="actions">
		<div class="button-group">
			...
			<button class="like ">
				<span class="icon-hand5"></span><span class="likeCount hidden-xs hidden-sm">450</span><span class="hidden-md hidden-lg hidden-xl">Like</span>
				<span class="icon-validate hidden-md hidden-lg hidden-xl check-icon"></span>
			</button>
	...
	<a href="programs-episode.html">
		...
		<div class="content">
			...
			<div class="title">We Asked bands About Their Worst live Experiences and also another bunch of things</div>
		</div>
	...
	<div class="actions">
		<div class="button-group">
			...
			<button class="like ">
				<span class="icon-hand5"></span><span class="likeCount hidden-xs hidden-sm">453</span><span class="hidden-md hidden-lg hidden-xl">Like</span>
				<span class="icon-validate hidden-md hidden-lg hidden-xl check-icon"></span>
			</button>
	...
	<a href="programs-episode.html">
		...
		<div class="cat-icon">
			<span class="icon-podcast_bold"></span>
		</div>
		...
		<div class="details">
			<span>Podcast <strong>04</strong></span>
		</div>
	...
	<div class="actions">
		<div class="button-group">
			...
			<button class="like ">
				<span class="icon-hand5"></span><span class="likeCount hidden-xs hidden-sm">786</span><span class="hidden-md hidden-lg hidden-xl">Like</span>
				<span class="icon-validate hidden-md hidden-lg hidden-xl check-icon"></span>
			</button>
	...
	<div class="actions">
		<div class="button-group">
			...
			<button class="like ">
				<span class="icon-hand5"></span><span class="likeCount hidden-xs hidden-sm">45</span><span class="hidden-md hidden-lg hidden-xl">Like</span>
				<span class="icon-validate hidden-md hidden-lg hidden-xl check-icon"></span>
			</button>
	...
	<div class="actions">
		<div class="button-group">
			...
			<button class="like ">
				<span class="icon-hand5"></span><span class="likeCount hidden-xs hidden-sm">65</span><span class="hidden-md hidden-lg hidden-xl">Like</span>
				<span class="icon-validate hidden-md hidden-lg hidden-xl check-icon"></span>
			</button>
	...
	<a href="programs-episode.html">
		...
		<div class="visu">
			<img src="assets/img/content/content_11.jpg" alt="">
		</div>
		<div class="cat-icon">
			<span class="icon-video_bold"></span>
		</div>
			...
			<div class="logo hidden-xl hidden-lg hidden-md">
				<img src="assets/img/content/logo-mixitup.png" alt="Warm Up">
			</div>
	...
	<div class="actions">
		<div class="button-group">
			...
			<button class="like ">
				<span class="icon-hand5"></span><span class="likeCount hidden-xs hidden-sm">456</span><span class="hidden-md hidden-lg hidden-xl">Like</span>
				<span class="icon-validate hidden-md hidden-lg hidden-xl check-icon"></span>
			</button>
	...
	<a href="programs-episode.html">
		...
		<div class="cat-icon">
			...
			<div class="logo hidden-xl hidden-lg hidden-md">
				<img src="assets/img/content/logo-freethebass.png" alt="Warm Up">
			</div>
	...
	<div class="actions">
		<div class="button-group">
			...
			<button class="like ">
				<span class="icon-hand5"></span><span class="likeCount hidden-xs hidden-sm">721</span><span class="hidden-md hidden-lg hidden-xl">Like</span>
				<span class="icon-validate hidden-md hidden-lg hidden-xl check-icon"></span>
			</button>
