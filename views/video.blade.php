	...
	<div class="video ">
		...
		<div class="actions">
			...
			<button class="watch_later">
				<span class="icon-watch_later"></span>Watch Later
			</button>
			...
			<button class="like">
				<span class="icon-hand5"></span>15654
			</button>
                        ...
                        <div class="col-md-4 col-md-pull-8">
                            ...
                            <div class="title">
                                <a href="program1.html">
                                    <img src="assets/img/content/logo-freethebass-black.png" alt="Free the bass">
                                </a>
                                <h3>A momentous first date with <span class="cutWord">Joy and Miley George</span></h3>
                                <h5 class="video">
